...
function renderReportMarkdown(report, roots) {
  ...
  if (report.settleWidened !== void 0) {
    lines.push(
      "- **Settle widened**: " + String(report.settleWidened.fromMs) + "ms \u2192 " + String(report.settleWidened.toMs) + "ms at " + (report.settleWidened.at === "initial" ? "initial" : "step " + String(report.settleWidened.at))
    );
  }
  lines.push("");
  lines.push("## Steps");
